...
inp1PWM.start(0)#The parameter of .start() is the motor's duty cycle (0-100).
inp2PWM.start(0)#That means what percent of the time there is voltage flowing per cycle
inp3PWM.start(0)#I have these four pins instanciated at 0 so the motors don't move yet.
inp4PWM.start(0)


speed = 70   #Instanciate the duty cycle of the motors. (70% of the time the motors will be moving)
wDown= False
aDown= False
sDown= False
dDown= False
...
#See what keys are pressed, and assign that value to a boolean.
    ...
    elif wDown==True and aDown==True and sDown==False and dDown==False:#North_West
